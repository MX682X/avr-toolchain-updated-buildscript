...
if [[ ! -f ${DOWNLOAD_DIR}/${ATMEL_ATMEGA_PACK_FILENAME}.zip  ]] ; then 	# check if we already downloaded the tar
    	wget ${ATMEL_ATMEGA_PACK_URL} -P ${DOWNLOAD_DIR}
    	
    	mkdir -p atpack
	rm -rf ./atpack/*

	mv ${DOWNLOAD_DIR}/${ATMEL_ATMEGA_PACK_FILENAME}.atpack ${DOWNLOAD_DIR}/${ATMEL_ATMEGA_PACK_FILENAME}.zip
	unzip -q ${DOWNLOAD_DIR}/${ATMEL_ATMEGA_PACK_FILENAME}.zip -d ./atpack
fi
